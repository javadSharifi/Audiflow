...
/**
 * AudioCaptureManager: Captures internal digital system audio via MediaProjection AudioPlaybackCapture.
 * Streams 16kHz 16-bit Mono PCM directly to the Live Dubbing engine.
...
class AudioCaptureManager {
    ...
    fun startCapture(
        ...
        try {
            ...
            Thread {
                ...
                while (isRecording) {
                    ...
                    if (read > 0) {
                        chunksRead++
                        if (chunksRead % 50 == 0) {
                            Log.d(TAG, "Captured $chunksRead audio chunks of size $read")
                        }
            ...
            Log.e(TAG, "Error starting AudioPlaybackCapture", e)
        }
    }
