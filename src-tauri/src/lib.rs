...
pub fn specta_builder() -> tauri_specta::Builder<tauri::Wry> {
    tauri_specta::Builder::<tauri::Wry>::new().commands(tauri_specta::collect_commands![
        ...
        commands::android_player_set_booster_gain_mb,
        commands::android_player_get_booster_gain_mb,
        commands::android_get_stream_volume,
        commands::android_get_stream_max_volume,
        commands::android_set_stream_volume,
        commands::android_apply_reduce_hurt,
...
pub fn run() {
    ...
    {
        tauri_builder =
            tauri_builder.plugin(tauri_plugin_single_instance::init(|app, argv, _cwd| {
